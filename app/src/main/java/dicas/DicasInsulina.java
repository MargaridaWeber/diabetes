...
public class DicasInsulina extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dicas_insulina);
        ...
        actionBar.setTitle(Html.fromHtml("<font color='#0060a2'>Dicas Insulina</font>")); //Cor do titulo
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_dicas_insulina, container, false);
