...
public class ConfiguracoesGeraisActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle(Html.fromHtml("<font color='#0060a2'>Configurações Gerais </font>")); //Cor do titulo
